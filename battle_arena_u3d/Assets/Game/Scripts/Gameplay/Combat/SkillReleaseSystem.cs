...
public partial struct SkillReleaseSystem : ISystem
{
    [BurstCompile]
    public void OnCreate(ref SystemState state)
    {
        state.RequireForUpdate<EffectData>();
    }
    ...
    partial struct UpdateJob : IJobEntity
    {
        ...
        public void Execute(ref EffectData data, Entity entity, [ChunkIndexInQuery] int sortKey)
        {
